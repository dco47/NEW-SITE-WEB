    ...
    const navLinks: NavLink[] = [
        ...
        { label: "Projects",
          href: "/UI-Components/Projects/Project",
            ...
            { label: "Project Details", href: "/app/UI-Components/Projects/ProjectDetails/2" },
         ],
        },
        {
            label: "Blogs",
            ...
            dropdown: [
                ...
                { label: "Blogs Delails", href: "/app/UI-Components/Blogs/BlogDetails/2" },
            ]
        },
    ...
    <>
        ...
        >
          <div className="flex items-center justify-between px-[8%] lg:px-[16%] py-5">
            ...
            >
                Blue<span className="text-(--white)">Orbit</span>
            </Link>
            ...
            <div className="flex items-center gap-4">
                ...
                >
                    <i className={`bi bi-brightness-high-fill text-(--white) text-lg transition-all duration-300 ${darkMode ? "rotate-0 opacity-100" : "rotate-90 opacity-0"}`}>
                    </i>
                    <i className={`bi bi-moon-stars-fill text-white text-xl transition-all duration-300 absolute ${darkMode ? "rotate-90 opacity-0" : "rotate-0 opacity-100"}`}>
                    </i>
                </div>
                <Link href="/">
                ...
                >
                    <i className={`ri-${mobileMenuOpen ? "close-line" : "menu-3-line"}`}></i>
                </button>
            </div>
          </div>
            {/* Mobile Nav */}
             <div
                className= {`lg:hidden bg-(--bg-color) border-t border-gray-700 overflow-hidden transition-all duration-500 ${mobileMenuOpen ? "max-h-700px opacity-100 py-4" : " max-h-0 opacity-0 py-0" }`}
            >
             {/* Mobile Nav */}
<div
                    ...
                    <div>
                        ...
                        <div
                            className={`overflow-hidden transition-all duration-300 ${
                                openDropdowns[link.label] ? "max-h-96 opacity-100 mt-2" : "max-h-0 opacity-0"
                            }`}
                        >
                            <div className={`rounded-lg py-2 ${
                                ...
                                {link.dropdown.map((item) => (
                                    ...
                                    >
                                        <i className={`bi bi-gear text-xs mr-2 ${
