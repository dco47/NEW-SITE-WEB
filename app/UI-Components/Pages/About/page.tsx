...
const faqData: FAQItem[] = [
  {
    question: "Understanding company billing and account",
    answer:
  ...
  {
    question: "Updating your billing credit card",
    answer:
      "Nulla non sollicitudin. Morbi sit amet laoreet ipsum, vel pretium mi. Morbi varius, tellus in accumsan blandit, elit ligula eleifend velit, luctus mattis ante nulla condimentum nulla.",
  },
  {
...
export default function About() {
  ...
  return (
    <>
        ...
        <div className="space-y-4 w-full py-10">
          {faqData.map((item, index) => (
            ...
            >
              ...
              >
                <span className="text-2xl Notoserif text-(--text-color)">
                  {item.question}
                </span>
      ...
      <div className="px-[8%] lg:px-[16%] py-15">
        <div className="title flex flex-col items-center justify-center">
          <h1 className="NotoSerif font-bold text-5xl lg:w-[80%] leading-15 text-center mb-5">
